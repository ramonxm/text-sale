...
const Home: NextPage = () => {
  return (
    <>
      ...
      <div className="h-screen w-full  border-gray-200 bg-white shadow dark:border-gray-700 dark:bg-gray-800">
        <div className="flex h-full flex-col items-center justify-center">
          <h1 className="flex items-center gap-2 bg-gradient-to-r from-purple-400 to-pink-600 bg-clip-text text-8xl font-extrabold text-transparent">
            TextSale
            <svg
